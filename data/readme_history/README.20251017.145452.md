...
![LastUpdated](https://img.shields.io/badge/last_updated-2025--10--17_14:53:46-green)
...
## Sri Lanka codifies transparency to rebuild trust, as beneficial ownership rules bite and new AML pacts widen reach 🔎  

Sri Lanka accelerated corporate transparency reforms, with the Companies (Amendment) Act No. 12 of 2025 now mandating full disclosure of beneficial owners, ten-year BO registers, and filings via the eROC portal, backed by fines and criminal liability for directors and officers. Regulators and market bodies are operationalising the regime (seven BO forms; CDS alignment; digital signatures), with multiple briefings (Deloitte, Daily FT; ICCSL) translating the law for practitioners. The Central Bank’s FIU also secured Cabinet approval to sign MoUs with counterparts in the Vatican and Mauritius, expanding cross-border intelligence on money laundering and terror financing. These moves are anchored to the forthcoming FATF evaluation and aim to lift investor confidence dented by past opacity.  

## Governance faces stress tests: Geneva’s resolution passes, police controversies multiply, and anti-corruption goes digital ⚖️  

The UNHRC adopted its latest resolution on Sri Lanka without a vote, extending the external evidence-preservation mechanism and urging devolution via Provincial Council (PC) polls under the 13th Amendment. Domestically, policing came under scrutiny: the BASL decried the assault of a lawyer within Mount Lavinia Court; the Opposition alleged transfers bypassing the National Police Commission; and COPE rebuked CIDA over Rs. 15 million in legal fees and staff harassment. In parallel, CIABOC rolled out a new Case-File Tracking System (with Japanese support), digitising case flow and reporting—an institutional fix intended to convert outrage into outcomes. A UN technical mission engaged leaders on electoral reform, while the Government said PC elections will be held next year (under the old or a reformed system).  

## Ports, policy resets and revenue: record cargo, fresh laws, and a sharper Customs spear ⚓  

The Port of Colombo is on course to handle a record **8.2 million TEUs in 2025** as the India-backed WCT ramps up, with total capacity projected to double to **15 million TEUs by 2026**. SLPA posted post-tax profits of **Rs. 32.2 billion (Jan–Aug 2025)** (up 71% YoY) and pledged reinvestment to fortify transshipment hub status. Customs set a single-day revenue record of **Rs. 24.9 billion (15 Oct)** and YTD collections of **Rs. 1.86 trillion** (target: Rs. 2.11 trillion), aided by the resumption of vehicle imports. The Cabinet approved amendments to the 2021 Port City Act to restore investor clarity after repeal of strategic business regulations. Against this, the Government denied links between a Cabinet reshuffle and a probe into the release of 323 containers, and said any structural changes were to sharpen 2025 Budget execution. Separately, tourism authorities launched a sports-tourism task force to monetise signature events from marathons to cricket. 🚴‍♀️🏏  

## Trade compliance moves centre stage: the EU’s deforestation rule looms over rubber exports 🌱  

With the EU Deforestation Regulation (EUDR) coming into force **Dec 2025** for medium/large entities (and **June 2026** for SMEs), exporters—especially in rubber and rubber-based products—face granular due diligence (geolocation, risk assessment, mitigation) and potential fines up to **4% of EU-wide turnover** for non-compliance. Industry fora warned of complex family holdings, offshore chains, and data gaps; regulators pledged digitalisation and templates. The message: traceability and legality (land-use, labour, conservation, anti-corruption) are now market access prerequisites, not add-ons.  

## Health system triage: procurement, production, and persistent fragility 💉  

To shore up clinical supply, Cabinet greenlit **~Rs. 2.5 billion** in purchases, including epoetin syringes (Reliance Life Sciences), colistimethate sodium (Ceyoka), infliximab (Celltrion), and human growth hormone (A. Baur & Co.). The Health Minister inspected LAUGFS Life Sciences’ new sterile LVP plant (Euro Multiport, FFS), part of import substitution. Yet operational strains surfaced: a Lanka Government Cloud outage crippled online services (BMD, police clearance, eRL 2.0); doctors’ unions flagged simultaneous oversupply of **~100** SKUs and shortages in ICU drugs and sutures; and the CEB unions suspended a strike after the Minister accepted **24** proposals. The WHO SEARO meeting in Colombo adopted the “Colombo Declaration” on healthy ageing via primary care—timely as Sri Lanka races toward a **1-in-4 aged 65+ by 2045** profile.  

## Tax morale, revenue mix and household pressure: compliance climbs, but education gaps persist 📚  

Remittances hit **$695.7 million in September** and **$5.81 billion (Jan–Sep)** (+16.7% YoY), reinforcing external buffers. Gold prices hit new highs (22k sovereign: **Rs. 337,600**), reflecting local hedging. Authorities warned of predatory mobile lending apps and moved to modernise excise revenue systems (**Rs. 1.3 billion** contract). A national debate intensified on tax fairness: webinars and columns urged practical filing guidance and better outreach, while a Human Rights Watch report argued decades of low, regressive tax effort choked social spending (education at **1.5% of GDP** in 2022) and worsened inequality. The new minimum wage law lifts private pay to **Rs. 27,000 from Apr 2025** (and **Rs. 30,000 from Jan 2026**), but enforcement and SME absorption will be the test.  

## Energy transition meets balance-sheet reality: green projects advance, but rooftop batteries need cheap credit ⚡🌬️  

WindForce acquired **51%** of a **10 MW** wind project in Puttalam (Rs. **4.2 billion**, 75:25 debt-equity), adding to a pipeline of private renewables. Apparel majors deepened climate commitments (Net Zero roadmaps; 39% renewables at MAS; waste-to-landfill diversion at 99%); CEAT Kelani secured ISO 14064-1:2018 for GHG reporting; and Ceylinco Life’s “Green Club” scaled e-waste and reforestation. A new evening feed-in tariff (**Rs. 45.80/kWh, 6–10 p.m.**) for solar-plus-battery systems looks bankable on paper, but experts warned current **15–18%** loan rates push payback well beyond battery life—concessional finance will decide uptake.  

## Memory, inclusion and land: Black October at 35, and a fresh contest over blue carbon 🕊️🌊  

The 35th anniversary of the **1990 mass expulsion of ~75,000 Northern Muslims** by the LTTE revived calls for inclusive memory and rights. Parallel debates underscore the cost of ignoring ecological law: conservationists urged the Government to block a **52-acre** international cricket complex at Mandaitivu (a declared reserve with mangroves/seagrass) as incompatible with the UDA’s “high sensitivity zone” and Sri Lanka’s blue carbon pledges, urging nature-based tourism instead. A broader editorial consensus is emerging: an inclusive polity and intact ecosystems are pillars of long-run competitiveness, not optional extras.  

## Digital and human capital bets: AI partnerships, mental health platforms, and tech hiring spur growth 🤖🧠  

Global AI ripples touched Colombo: Salesforce and OpenAI expanded a partnership to embed frontier models into enterprise workflows, while Virtusa announced **200+** new roles in AI/data/DevOps as it targets $5 billion revenue by 2030. eChannelling launched “eMindCare,” an integrated mental health platform (psychiatry, counselling, yoga/meditation, tri-lingual content). Universities stepped up regional sustainability leadership, and SME bodies pushed governance and marketing upskilling. The subtext: talent, trust, and tooling are now Sri Lanka’s principal growth levers.  

## Logistics, boards and markets: capital formation inches forward as governance deepens 📈  

CSE turnover repeatedly topped **Rs. 8 billion**, buoyed by crossings in blue chips; SLT-MOBITEL ranked the country’s top telecom brand in August (PepperCube), and Hayleys topped the LMD 100 with **Rs. 492.2 billion** revenue and **Rs. 35.4 billion** PBT in 2024/25. IPO pipelines stir (JF Packaging’s investor forum on 21 Oct), wind/energy deals closed, and boardrooms refreshed (Hemas Assurance, LAUGFS Gas/Power, Avinya Foundation) alongside rising director education. On the ground, courts upheld fair public access to Samanalawewa for tourism operators, and a Court of Appeal signal opened conditional release of vehicles detained over LC anomalies—small, practical wins for rule-of-law credibility.  

In sum, the week showed Sri Lanka bending policy toward transparency, external compliance and green growth, even as it wrestles with brittle service delivery and contested politics. The prize—lower risk premia, steadier inflows, and better human capital—requires staying the course on reforms that are unglamorous but compounding.
...
131. `2025-10-12` Ceylon Agro Food Technologies: Cultivating solutions for Sri Lanka’s agri-crisis [islandlk](http://island.lk/ceylon-agro-food-technologies-cultivating-solutions-for-sri-lankas-agri-crisis/)
...
133. `2025-10-12` Thimark Technocreations secures export deal with Kenya, showcasing SL engineering exports [islandlk](http://island.lk/thimark-technocreations-secures-export-deal-with-kenya-showcasing-sl-engineering-exports/)
...
145. `2025-10-11` Ceylinco Life’s Green Club drives meaningful sustainability impact in first half of 2025 [islandlk](http://island.lk/ceylinco-lifes-green-club-drives-meaningful-sustainability-impact-in-first-half-of-2025/)
