# 🇱🇰 Sri Lanka This Week
Generated at 02:18 PM (October 17, 2025) by **gpt-5** from 178 English News Articles published between **2025-10-10** and **2025-10-17**.

## Sri Lanka’s recovery narrative pivots on state capacity: transparency rules pass, digital tools arrive, but enforcement lags.  
Colombo is tightening the plumbing of the state while scrambling to deliver services. Parliament’s new Companies (Amendment) Act mandates disclosure of beneficial owners and bans bearer shares, with penalties for non-compliance—an IMF-era pledge now on the books. Regulators concede the hard part starts now: tracing layered ownership through offshore vehicles and family-held assets will test the Registrar’s e-platform, firms’ record‑keeping, and market infrastructure (e.g., CDS) more than the law (verification still pending on forms B01–B07). Meanwhile, the anti-corruption watchdog rolled out a UNDP/Japan‑funded Case‑File Tracking System to modernise investigations, aligning with IMF conditions on case statistics and flow management. The digital backbone shows strain too: an outage at the Lanka Government Cloud knocked out registries and payments, highlighting why resilience—not just reform—is the new watchword.

## Revenues and ports surge, but customs governance remains in the dock.  
Revenue agencies are minting record takings even as governance questions multiply. Sri Lanka Customs booked a single‑day record of **Rs. 24.9 billion (15 Oct)**, pushing year‑to‑date collections to **Rs. 1.86 trillion** against a **Rs. 2.11 trillion** target, helped by the resumption of vehicle imports. The Ports Authority reported post‑tax profit of **Rs. 32.2 billion** in Jan–Aug (up **71%** YoY), and Colombo Port is on course for a record **8.2m TEUs in 2025** amid WCT ramp‑up; total capacity is slated to double to **15m TEUs by 2026**. Yet the year’s most politically toxic controversy—release of **323 containers** without full inspection—continues to dog the government. The Court of Appeal heard that non‑compliant vehicles can be released under bond, while the Cabinet spokesman insists inquiries (including alleged **14** previous episodes) are ongoing. Record receipts with uneven controls is a fragile equilibrium.

## Growth leans on logistics and concrete: expressways resume under BRI while ports, housing and malls expand.  
The resumption of the Central Expressway Section I (Kadawatha–Mirigama) underscores China’s role in Sri Lanka’s public investment cycle. Officials call it the first large project to restart since the 2022 default, financed via a yuan‑denominated line and budget allocations, with completion targeted by **mid‑2028**. Colombo Port’s profits, new cranes and terminals, and private capital in real estate (e.g., Havelock City Mall’s expansion; Home Lands’ expo with **100%** financing tie‑ups) point to a return of scale. The risk remains the old one: projects must meet cost, transparency and climate screens, not only shovel‑readiness.

## Labour markets and wages move, but health supply chains remain brittle.  
Policy is tilting toward household incomes. The National Minimum Wage rises to **Rs. 27,000** a month from **1 April 2025** (to **Rs. 30,000** from **1 Jan 2026**) and now anchors EPF/ETF, OT, maternity and holiday entitlements. In parallel, health procurement continues to fire-fight shortages: Cabinet approved **~Rs. 2.5bn** of medicines and devices (epoetin, infliximab, growth hormone), but doctors report oversupply of ~**100** drug lines alongside acute shortages (e.g., IV Noradrenaline, Cefotaxime, implants), blaming weak planning and emergency buys. The CEB unions suspended their strike after the minister agreed to **24** union proposals—an industrial détente that reduces outage risk, for now.

## Politics experiments at the centre, but provincial devolution returns to the agenda.  
The Opposition’s SJB and the UNP have agreed a joint program “guided by SJB”, signalling a consolidation of centre‑right policy space ahead of provincial contests. The government says Provincial Council elections will be held in **2026** “under the old or a new system”, but legislative timelines remain vague; UNHRC language urging devolution (13A) and PC polls adds external pressure. A UN technical mission engaged both government and opposition on electoral reforms (women’s participation, digitalisation, voter education)—a reminder that donor scrutiny extends beyond budgets to institutions.

## Trade winds shift: EU’s deforestation rule, US tariffs and rare‑earths ambition test exporters.  
Exporters face sharper compliance curves. The EU Deforestation Regulation (EUDR) kicks in by **Dec 2025** (large/medium) and **June 2026** (SMEs), covering commodities including rubber and derivatives. Companies must file due‑diligence dossiers with geolocation data, prove legality across land, labour, environmental and third‑party rights, and face penalties up to **4%** of EU‑wide turnover for non‑compliance. With US tariffs biting in key sectors, Sri Lanka must upgrade traceability (especially rubber), harmonise registries and digitise supply‑chain attestations—or cede market share. A complementary opportunity flickers: geologists and industry advocates argue Sri Lanka’s mineral sands (monazite) and world‑class vein graphite could anchor a critical‑minerals niche—if a credible survey, ESG frameworks and investor partnership strategy are put in place.

## Private capital and markets are back in the room, even as cost of capital bites.  
The bourse has rediscovered momentum on IMF‑tailwinds and earnings: turnover repeatedly topped **Rs. 8 billion**, the ASPI’s market cap cleared **Rs. 8 trillion**, and crossings (Hemas, DFCC, HNB, Central Finance) are thickening. IPOs are thawing (JF Packaging investor forum on **21 Oct**), while M&A continues (World Elite’s **50.01%** of Gestetner; WindForce’s **51%** in a **10MW** wind project; LAL’s **Rs. 7.75bn** H1 revenue; Hayleys topping LMD100 with **Rs. 492bn** revenue). The stronger pipeline coexists with high borrowing costs: households struggle to finance rooftop BESS despite a **Rs. 45.80/kWh** peak export tariff—returns pencil on paper, not with **15–18%** loan rates.

## Tourism pursues depth, not just headcount: sports, science and research-led repositioning.  
Officials are finally treating sports and knowledge as visitor magnets. A new operations committee will integrate sports events (cricket, rugby, surfing) into destination marketing and infrastructure plans. The Sri Lanka Tourism conference pushed a research‑led framework linking FX earnings, jobs and regional value chains—long advocated, seldom executed. Local courts backed open access to Samanalawewa for canoe/kayak operators, a small but telling win for level playing fields. The flip side: environmental governance must keep pace—civil society is warning against siting a cricket complex on Mandaitivu’s blue‑carbon ecosystems, risking the very assets that differentiate Sri Lanka.

## Governance by code and by culture: corporate boards, AI governance and workplace inclusion move up the agenda.  
Directors are being told to get fitter for a new regulatory and technological cycle. The Sri Lanka Institute of Directors is pushing succession, AI/data oversight and ESG integration as board‑level competencies. The Deloitte and National Chamber workshops on BO registers and SME governance show mid‑market appetite for playbooks. On the shopfloor, Great Place to Work’s CXO forum underlined multi‑generational leadership, empathy, and AI‑assisted decision‑making; the best‑workplaces list for young talent extends from insurance to manufacturing and tech—proof that culture is a competitiveness lever, not a soft option.

## External flows stabilise the macro; policy credibility must lock them in.  
Remittances hit **$695.7m** in September (**+25%** YoY), with **$5.81bn** in Jan–Sep (**+16.7%**), and the SLBFE eyeing **$7bn** by year‑end and **300,000** departures in **2025**. The rupee has steadied near **Rs. 303/USD** as bond yields grind lower; Cabinet cleared **dollar bond** issuance as a short‑term liquidity tool, and Port City amendments will be redrafted after repeal of earlier regulations spooked investors. The agenda is hiding in plain sight: cut tariffs and non‑tariff barriers, modernise customs, simplify and stabilise taxes, de‑politicise the bureaucracy, and update rigid labour codes. As one seasoned economist put it, the IMF is a bandage; the cure is structural reform. 🇱🇰

## Bottom line: reform is now a delivery game, not a drafting one.  
Sri Lanka has progressed from promises to instruments—beneficial ownership rules, anti‑corruption systems, wage floors, port capacity, and expressways restarting. But credibility now depends on enforcing the hard bits (beneficial ownership, customs controls), sequencing the smart bits (EUDR compliance, AI/data governance), and funding the future bits (critical minerals, BESS, grid reform). The numbers are encouraging—**ports up**, **revenues up**, **remittances up**—but only a state that works can turn them into lasting prosperity.
...
113. `2025-10-13` Universities seen as ‘catalysts of real-world environmental change’ [islandlk](http://island.lk/universities-seen-as-catalysts-of-real-world-environmental-change/)
...
134. `2025-10-12` Thimark Technocreations secures export deal with Kenya, showcasing SL engineering exports [islandlk](http://island.lk/thimark-technocreations-secures-export-deal-with-kenya-showcasing-sl-engineering-exports/)
...
144. `2025-10-11` Ceylinco Life’s Green Club drives meaningful sustainability impact in first half of 2025 [islandlk](http://island.lk/ceylinco-lifes-green-club-drives-meaningful-sustainability-impact-in-first-half-of-2025/)
