# 🇱🇰 Sri Lanka This Week
*Generated at 11:28 AM (October 17, 2025) by **gpt-5** from 178 English News Articles published between **2025-10-10** and **2025-10-17**.

## Sri Lanka signals pragmatic diplomacy abroad even as Geneva keeps the heat on.  
Colombo avoided forcing a vote on the latest UNHRC resolution, which extends the Office of the High Commissioner’s Sri Lanka Accountability Project, wagering that engagement preserves goodwill after “Core Group” pressure. The Government reiterated a domestic track for reconciliation while the Council’s action—despite objections that it breaches UN Charter Article 2(7)—keeps wartime accountability on the docket. Domestically, devolution returned to center stage: ministers now promise Provincial Council elections “next year” under the old or a new law, even as civil society warns of drift.

## Inclusion is the policy mantra at home, but timelines on political reform remain vague.  
Government messaging in Geneva and Colombo emphasizes fairness—ending discrimination against LGBTIQ citizens, banning corporal punishment in schools, and widening the “national circle of belonging.” Yet Tamil parties decry a year of silence on core grievances and demand PC polls without delay. A UN Technical Electoral Needs Assessment Mission sounded ready to assist on transparency, women’s participation, youth access and digitalisation, but delivery will hinge on legal fixes the Election Commission still lacks.

## Revenues and trade are rebounding as the State leans on modernisation—and higher floors for wages. 📈  
Customs posted a record single-day intake of **Rs. 24.9 billion** and year-to-date revenue of **Rs. 1.86 trillion**; the Colombo Port booked **Rs. 32.2 billion** post-tax profit in Jan–Aug and targets **8.2m TEUs** in 2025 as West Container Terminal ramps. Migrant remittances hit **$695.7m** in September (**$5.81bn** in nine months, +16.7% y/y). Cabinet approved a national minimum wage rise to **Rs. 27,000** (to **Rs. 30,000** from Jan 2026). New Excise IT systems (Rs. 1.3b) and Customs admin tweaks aim to harden collection, while policy voices urge bolstering “tax morale” to lift compliance and fund education and health.

## Market exuberance returns, but investors still want structural reforms, not sugar highs.  
Turnover repeatedly topped **Rs. 8 billion** as crossings and banks led the CSE rally, buoyed by improving macro optics and port earnings. Yet analysts—and former central bankers—flag the same bottlenecks: **high tariffs, non‑tariff barriers, customs frictions, unpredictable taxes, rigid labour rules, and an over‑politicised bureaucracy** that together depress FDI. Colombo is tweaking levers—dollar bonds as a short-term liquidity tool, fresh Port City amendments after scrapping old “strategic business” rules—but credibility hinges on steady execution rather than episodic resets.

## Anti‑corruption digitalisation is inching forward, even as core infrastructure shows fragility. 🛰️  
The Bribery Commission (CIABOC), with UNDP/Japan support, launched a Case‑File Tracking System, backed by **$202,000** in hardware and staff training, aligned to IMF governance benchmarks and e‑procurement reforms. In contrast, an outage at the Lanka Government Cloud took key registries, licensing, pensions and meteorology portals offline, underlining capacity and redundancy gaps the next LGC expansion must fix. The CID juggles **20,000+** investigations, illustrating caseload strain across policing and justice.

## Law‑and‑order gets tougher on narcotics while policing standards face public scrutiny. ⚖️  
A Navy-led seizure netted **670 kg** of crystal meth, **157 kg** of heroin and **12 kg** of hashish drifting in southern seas, with five suspects arrested and interdiction pressure rising on maritime routes. At the same time, a court‑premises scuffle between a lawyer and a constable triggered outrage, remand, and dueling narratives—testing the Bar’s resolve and Police accountability. On roads, commentators renewed calls to pivot enforcement from “white‑line” fines to the lethal mix of speeding, drink‑driving and lane indiscipline that claims **8–10 lives daily**.

## The energy transition is gathering pace—if finance and labour peace can keep up. 🌬️  
WindForce acquired **51%** of Safe Power International to build a **10 MW** wind farm at Alankuda (Rs. **4.2b**, 75:25 debt‑equity), underscoring private appetite for renewables. CEB unions suspended a six‑week strike after the Minister accepted **24** proposals, easing near‑term supply risk. For households, a new **Rs. 45.80/kWh** evening feed‑in tariff for solar‑plus‑batteries looks attractive on paper (simple payback ~6–8 years) but **15–18%** loan rates make adoption prohibitive without concessional finance.

## Health and ageing are rising on the policy slate, alongside mental wellbeing and procurement. 🧓🧠  
WHO South‑East Asia’s ministers signed the “Colombo Declaration” to embed healthy ageing through primary care. The Health Ministry fast‑tracked **~Rs. 2.5b** in procurements (epoetin, antibiotics, infliximab, growth hormone, dressings) amid chronic shortages. Meanwhile, eChannelling launched “eMindCare,” a digital platform for psychiatry, counselling, yoga and mental‑health literacy—timely as urban pollution and toxins are linked to rising dementia and Parkinson’s disease in op‑eds.

## Education reform needs context, capacity and teacher support more than closures.  
Debate intensified over proposals to merge or shut small schools, as fieldwork from border districts highlighted staffing gaps, special‑needs support deficits, and the need for formative‑stage teacher training. Universities pursued bridges—India’s Guru Kashi University inked a partnership with Oxford Chester Uni (SL), and public schools showcased boarding models—while a UN mission canvassed electoral literacy and inclusion. The gap between policy ambition and local capacity remains the reform pivot.

## Trade and climate compliance are converging quickly; blue‑carbon assets can’t be collateral damage. 🌿  
EU’s Deforestation Regulation (EUDR) arrives end‑2025, sweeping in **rubber** supply chains (among seven “forest-risk” commodities) with geolocation due diligence, 10‑year record‑keeping and fines up to **4%** of EU‑wide turnover; Sri Lankan exporters need legal mapping, traceability and smallholder support fast. Conservationists warn that siting a cricket stadium on **Mandaitivu** would strip mangroves and seagrass—Sri Lanka’s “blue carbon” shield—undercutting tourism and fisheries. A rare‑earths and graphite blueprint could build a new export pillar if surveys, standards and partnerships advance; GI (geographical indications) work on Ceylon Tea continues. Apparel majors doubled down on **Net Zero** targets and circularity, sustaining the sector’s ESG premium.

## Tourism’s rebound is broadening—from sports to shared waterways—while courts police fair access. 🚢  
A new public‑private committee will push sports tourism (cricket, rugby, surfing), aiming to monetise events the country already hosts. The Court of Appeal affirmed open access to Samanalawewa for operators, requiring transparent fee regimes and curbing exclusivity. The Colombo Port forecasts a capacity jump to **15m TEUs** by 2026, collateral good news for cruise and transshipment‑adjacent services.

## The State is legislating for the data and digital economy, but delivery will define trust.  
Parliament will take up amendments to the **Personal Data Protection Act** and debate a national anti‑drug operation. A Companies Act update enforces **beneficial‑owner** disclosure (with Central Depository System support) amid concerns about complex offshore structures; lapses carry fines and liability for directors and secretaries. The test now is consistent enforcement and reliable infrastructure, not just new statutes.
...
112. `2025-10-13` National Chamber hosts one-day workshop on “Corporate Governance for SMEs” [islandlk](http://island.lk/national-chamber-hosts-one-day-workshop-on-corporate-governance-for-smes/)
...
132. `2025-10-12` No-IMF path would have been ‘twice as painful’ for Sri Lanka, says Dr. Ahluwalia [islandlk](http://island.lk/no-imf-path-would-have-been-twice-as-painful-for-sri-lanka-says-dr-ahluwalia/)
